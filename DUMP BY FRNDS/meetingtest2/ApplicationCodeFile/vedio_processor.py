...
def process_video_in_chunks(video_filename):
    ...
    # Also write a machine-readable JSON summary for the grid regions
...
if __name__ == '__main__':
    import sys
    # Allow passing a video path as a CLI argument; default kept for backward compat
    video_arg = sys.argv[1] if len(sys.argv) > 1 else "test3.mp4"
    process_video_in_chunks(video_arg)